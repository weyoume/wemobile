...
namespace Steepshot.Core.HttpClient
{
    public interface ISteepshotApiClient
    {
        ...
        Task<OperationResult<ImageUploadResponse>> CreatePost(UploadImageRequest request, UploadResponse uploadResponse, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetUserPosts(UserPostsRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetUserRecentPosts(CensoredNamedRequestWithOffsetLimitFields request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetPosts(PostsRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetPostsByCategory(PostsByCategoryRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> GetPostVoters(VotersRequest request, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/post/@joseph.kalu/cat636203355240074655/comments HTTP/1.1
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetComments(NamedInfoRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<SearchResult>>> GetCategories(OffsetLimitFields request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<SearchResult>>> SearchCategories(SearchWithQueryRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> GetUserFriends(UserFriendsRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> SearchUser(SearchWithQueryRequest request, CancellationToken ct);
        ...
        Task<OperationResult<VoidResponse>> DeletePostOrComment(DeleteRequest request, CancellationToken ct);
    }
}
